...
def play_game():
  ...
  # function made for dealing out random cards
  def deal_card():
    return random.choice(cards)

# function made for calculating the score of a hand 
  ...
  # def blackjack_check(chosen_score, chosen_name):
  #   # If the user has a blackjack (0), then the user wins.
  #   if chosen_score == 0:
  #     print(f"3 Blackjack game over {chosen_name} win")
  #   # If the user_score is over 21, then the user loses.
  #   if chosen_score > 21:
  #     print(f"4 Bust game over {chosen_name} wins")
  ...
  # blackjack_check(user_score, user_name)
  # blackjack_check(computer_score, computer_name)
  while keep_dealing:
  ...
  while game_over == False:
    if computer_score < 17:
      ...
      if computer_score == 0:
        print("7 Blackjack game over CPU win")
        game_over == True
        
      if computer_score > 21:
        print("9 Bust game over CPU win")
        game_over == True
